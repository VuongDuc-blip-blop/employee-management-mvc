...
| WEB-010 | EF transaction commit/rollback | `web.md` EF transaction | PREFERRED_CONVENTION / PRODUCTION | SAFE | MASTERED | ERP-0001 credential upgrade/change passed; later mutations |

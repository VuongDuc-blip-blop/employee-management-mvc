app.controller('QtyChartCtrl', function ($scope, $http, $interval) {
    ...
    $scope.LoadQuantitiesChart = function () {
        $http.post('/api/Api_PatliteInfor/QuantitiesChartNew', thamso).then(function (response) {
    ...
    $scope.LoadNewChart = function () {
        $http.post('/api/Api_PatliteInfor/QuantitiesChartNew').then(function (response) {

app.controller('ChartCtrl', function ($scope, $http, $interval, ajaxService) {
    var today = new Date();
    ...
    function CreateDailyChart(item) {
        ...
        $http.post('/api/Api_Machine/QuantityChart', thamso).then(function (data) {
            console.log(data)
            var chart = {
                ...
                tooltip: {
                    ...
                    pointFormat:
                        ...
                        '<span style="font-weight:' + tooltip_caption_fontWeight + ';">&nbsp;Actual Qty</span></td>' +
                        '<td style="width:60%; text-align:right;">&nbsp;&nbsp;{point.ACTUAL_QTY}&nbsp</td>' +
                        '</div>' +
                        '</tr>',
                    footerFormat: '</table>',
                    //valueDecimals: 2,
